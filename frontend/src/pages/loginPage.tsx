...
export default function LoginPage() {
  ...
  return (
    <main className="bg-muted flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10 relative card">
      <div className="w-full max-w-md sm:max-w-lg border p-6 sm:p-8 rounded-xl bg-accent drop-shadow-red-500 drop-shadow-sm flex flex-col gap-6">
        ...
        >
          <div className="w-full flex flex-col gap-3 sm:gap-4 p-2 sm:p-0">
            ...
            <input
              ...
              className="w-full rounded-xl border border-accent-secondary py-2 px-3 focus:outline-accent-secondary hover:bg-accent-secondary transition-all duration-300"
              value={email}
              required
